...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <a class="nav-link btn btn-primary" href="<?php echo base_url('Honorer'); ?>">
                                ...
                                <div class="row">
                                    <div class="container">
                                        ...
                                        <div class="col-md-3 ">
                                            ...
                                            <?php
                                            echo "<img src='assets/uploads/foto/honorer/foto-$no_induk.png' width='220' height='220' />";

                                            ?><br>

                                            <?php echo form_open_multipart('Honorerdt/aksi_upload'); ?>
                                        ...
                                        <div class="col-md-3 ">
                                            <label class="control-label ">ID CARD HONORER</label><br>
                                            <?php echo "<img src='assets/uploads/id-card/honorer/idcard-$no_induk.png' width='325' height='502' />"; ?><br><br>
        ...
        <script type="text/javascript">
            function idcard(id) {
                var url = '<?php echo base_url('Honorerdt/get_honorer') ?>';
                var data = {
                    id: id
                };
            ...
            $('#btn_idcard').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Honorerdt/card') ?>",
                    dataType: "JSON",
                    data: {
                        no_induk: no_induk,
                        nama: nama
            ...
            function down(no_induk) {
                var url = 'Honorerdt/download?no_induk=__no_induk__ ';
