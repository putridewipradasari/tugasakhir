                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <!--div class="box-header">
                                    <div class="row">
                                        <div class="container">
                                            <h3 class="bmd-label-floating">Tamu Masuk</h3>
                                        </div>
                                    </div>
                                </!--div-->
                                    ...
                                    <div class="container">
                                        <div class="col-md-6 ">
                                            <form>
                                                ...
                                                <input type="hidden" id="id_kartu" nama="id_kartu" value="<?php echo $id_kartu; ?>" class="form-control">
                                                ...
                                                <div class="form_group">
                                                    <div class="form-group bmd-form-group">
                                                        ...
                                                        <textarea class="form-control" id="tujuan" rows="3" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="form_group">
                                                    <div class="form-group bmd-form-group">
